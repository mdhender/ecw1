...
Abbreviations: **TL** = Tech Level (integer 1–200) · **MU** = Mass Unit · **VU** = Volume Unit · **TBD** = not yet specified.
...
| CSUP      | Combat Supplies     | Ammunition     | no         | 0.04            | 0.02            | 0.02               | 0.02            | 0.02                | N/A                                                                    | Consumed in combat - 1 per soldier per combat round                                           |
...
| FACT      | Factory             | Infrastructure | yes        | 2 × (TL + 6)    | 2 × (TL + 6)    | TL + 6             | TL + 8          | 4 + TL              | 1 professional 3 unskilled and 0.5 × TL fuel or power                  | Produces 5 × TL mass per turn see Manufacturing                                              |
...
| HDRV      | Hyper Drive         | Propulsion     | yes        | 45 × TL         | 45 × TL         | 22.5 × TL          | 25 × TL         | 20 × TL             | 1 professional / 100 and 40 fuel only per light year                   | Lift capacity 1045 × TL range is (Square root of TL) × 3                                      |
...
| RBL       | Rebel               | Cadre          | no         | 1               | 1               | —                  | N/A             | N/A                 | N/A                                                                    | Living units assigned to rebellion; drawn from any Living type                                  |
...
| SOL       | Soldiers            | Living         | no         | 1               | 1               | —                  | N/A             | N/A                 | Food and Consumer Goods as well as 1 × combat supplies during combat   | Provide combat factors and also staffing for certain weapons systems                          |
...
| STRC      | Structure           | Structural     | yes        | 0.1 × TL        | negative        | 0.05 × TL          | 0.07 × TL       | 0.03 × TL           | Must be assembled to enclose volume                                    | Assembled volume is negative; encloses (1 × TL^2) divided by the Structure Ratio              |
| STRL      | Light Structure     | Structural     | yes        | 0.01 × TL       | negative        | 0.005 × TL         | 0.005 × TL      | 0.005 × TL          | Must be assembled to enclose volume                                    | Assembled volume negative; encloses (1 × TL^2) divided by the Structure Ratio; manufactured only in orbiting colonies |
